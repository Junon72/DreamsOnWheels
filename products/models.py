...
class Original(models.Model):
    ...
    build_year = models.PositiveIntegerField(default=0, blank=True)
    ...
    price_min = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=True)
    price_max = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=True)
...
class Vote(models.Model):
    ...
    highlight = models.ForeignKey(Original, on_delete=models.CASCADE)
