...
8. [Functional flow and Features](#Functional-Flow-And-Features)
9. [Admin site](#Admin-site)
10. [Technologies Used](#Technologies-Used)
11. [Project Setup](#Project-Setup)
12. [Testing](#Testing)
13. [Media and Content Origin](#Media-and-Content-Origin)
...
*Superuser*
Has superuser status and access to all admin functionality, includin ability to add,
...
Otherwise, there might rise conflicts between depndences in different Python projects.
...
Before adding the files on the workspace to the repository create a .git ignore file. In .gitignore add
files folders you do not want to be pushed to the GitHub or be seen by public. Such files include VSCode
...
Note, thet the setting are currently written for the bucket I have created for the project, so it might be that you need to chang the bucket name in setting.py to correspond yours.

1. To deploy the project on heroku, go to [Heroku](https://www.heroku.com/ "Heroku") and create an acoount.
2. create a new app, using `NEW` button.
a. Give app a name
b. Choose a region
c. Click `Create an app`

3. Got dashboard and click `Resources` tab, to create a Postgres database. You can start typin Postgres in the input field,
